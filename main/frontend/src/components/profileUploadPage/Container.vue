    ...
    <form method="put" enctype="multipart/form-data">
      ...
      <div class="cont2">
        ...
        <div class="upload-detail2">
          ...
          <br />
          <span class="span2" for="had_long_before" v-show="update.had_checkup">마지막으로 건강검진 받은 시기</span>
          <br />
          <input
          ...
          <input type="text" placeholder="ex)갑상선 수치에 이상이 있어요" v-model="update.had_checkup_comment" />
          <br />
          ...
          <input type="radio" :value="true" name="had_checkup" v-model="update.disease_boolean" />있음
          <input
            type="radio"
            name="had_checkup"
          ...
          <div v-for="disease in update.diagnosed_disease" :key="disease.name">
            <div v-if="disease.checked">
              ...
              <input type="text" placeholder="드시고 계신 약이 없다면 생략해주세요" v-model="disease.medicine" />
              <br />
              <span class="span2">{{ disease.name }}(은/는) 어디서 진단 받으셨나요?</span>
              <input type="text" placeholder="기억나지 않는다면 생략해주세요" v-model="disease.where" />
              <br />
            </div>
          </div>
          <!-- <input
