<template>
  <div class="section">
    ...
    <div class="question-body">
      <v-expansion-panels v-model="expand" multiple accordion class="expansion">
            ...
            <div class="answers">
              <div v-for="item in from_when" :key="item.id">
                <button
                  :ref="item[1]"
                  :value="item[1]"
                  @click="button_click('symptom_start', item[0]);clickedButton($event)"
...
export default {
  ...
  methods: {
    clickedButton(event) {
      ...
      if (this.$refs[value][0].className.includes("class")) {
        this.$refs[value][0].className = this.$refs[value][0].className.replace(
          " class",
          ""
        );
      } else {
        this.$refs[value][0].className =
          this.$refs[value][0].className + " class";
